<template>
    <main>
        <div class="max-w-lg p-6 bg-white mx-auto mt-10 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <h5 class="mb-2 text-2xl font-bold tracking-tight text-center text-gray-900 dark:text-white">TAMBAH USER</h5>
            <form class="max-w-sm mx-auto" @submit.prevent="addNewUser">
                <div class="mb-5">
